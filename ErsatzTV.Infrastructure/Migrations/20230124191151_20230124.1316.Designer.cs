...
namespace ErsatzTV.Infrastructure.Migrations
{
    ...
    [Migration("20230124191151_20230124.1316")]
    partial class _202301241316
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ErsatzTV.Core.Domain.ProgramScheduleItem", b =>
                {
                    ...
                    b.Property<int?>("MidRollEnterFillerId")
                        .HasColumnType("INTEGER");

                    b.Property<int?>("MidRollExitFillerId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("MidRollEnterFillerId");

                    b.HasIndex("MidRollExitFillerId");
            ...
            modelBuilder.Entity("ErsatzTV.Core.Domain.ProgramScheduleItem", b =>
                {
                    ...
                    b.HasOne("ErsatzTV.Core.Domain.Filler.FillerPreset", "MidRollEnterFiller")
                        .WithMany()
                        .HasForeignKey("MidRollEnterFillerId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("ErsatzTV.Core.Domain.Filler.FillerPreset", "MidRollExitFiller")
                        .WithMany()
                        .HasForeignKey("MidRollExitFillerId")
                        .OnDelete(DeleteBehavior.SetNull);
                    ...
                    b.Navigation("MidRollEnterFiller");

                    b.Navigation("MidRollExitFiller");
