...
namespace ErsatzTV.Api.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AddProgramScheduleItem")]
    public partial class AddProgramScheduleItem : IEquatable<AddProgramScheduleItem>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AddProgramScheduleItem" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AddProgramScheduleItem {\n");
        ...
        {
            return this.Equals(input as AddProgramScheduleItem);
        }

        /// <summary>
        /// Returns true if AddProgramScheduleItem instances are equal
        /// </summary>
        /// <param name="input">Instance of AddProgramScheduleItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddProgramScheduleItem input)
        {
            if (input == null)
                return false;
