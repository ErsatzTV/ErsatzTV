...
namespace ErsatzTV.Api.Sdk.Model
{
    ...
    /// CreateFFmpegProfile
    /// </summary>
    [DataContract(Name = "CreateFFmpegProfile")]
    public partial class CreateFFmpegProfile : IEquatable<CreateFFmpegProfile>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateFFmpegProfile" /> class.
        /// </summary>
        ...
        public CreateFFmpegProfile(string name = default(string), int threadCount = default(int), bool transcode = default(bool), int resolutionId = default(int), bool normalizeResolution = default(bool), string videoCodec = default(string), bool normalizeVideoCodec = default(bool), int videoBitrate = default(int), int videoBufferSize = default(int), string audioCodec = default(string), bool normalizeAudioCodec = default(bool), int audioBitrate = default(int), int audioBufferSize = default(int), int audioVolume = default(int), int audioChannels = default(int), int audioSampleRate = default(int), bool normalizeAudio = default(bool))
        {
            this.Name = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateFFmpegProfile {\n");
        ...
        {
            return this.Equals(input as CreateFFmpegProfile);
        }

        /// <summary>
        /// Returns true if CreateFFmpegProfile instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateFFmpegProfile to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateFFmpegProfile input)
        {
            if (input == null)
                return false;
