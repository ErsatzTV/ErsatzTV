...
namespace ErsatzTV.Api.Sdk.Model
{
    ...
    /// UpdateFFmpegProfile
    /// </summary>
    [DataContract(Name = "UpdateFFmpegProfile")]
    public partial class UpdateFFmpegProfile : IEquatable<UpdateFFmpegProfile>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateFFmpegProfile" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateFFmpegProfile {\n");
        ...
        {
            return this.Equals(input as UpdateFFmpegProfile);
        }

        /// <summary>
        /// Returns true if UpdateFFmpegProfile instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateFFmpegProfile to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateFFmpegProfile input)
        {
            if (input == null)
                return false;
